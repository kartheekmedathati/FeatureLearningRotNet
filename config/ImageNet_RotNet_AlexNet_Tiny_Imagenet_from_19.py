...
networks['model'] = {'def_file': 'architectures/AlexNet.py', 'pretrained': 'experiments/ImageNet_RotNet_AlexNet_Tiny_Imagenet/model_net_epoch19', 'opt': net_opt,  'optim_params': net_optim_params} 
