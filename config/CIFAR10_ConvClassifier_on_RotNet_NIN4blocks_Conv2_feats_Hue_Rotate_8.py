...
networks = {}
feat_net_opt = {'num_classes': 8, 'num_stages': 4, 'use_avg_on_conv3': False}
feat_pretrained_file = './experiments/CIFAR10_RotNet_NIN4blocks_Hue_Rotate_8/model_net_epoch200'
...
cls_net_optim_params = {'optim_type': 'sgd', 'lr': 0.1, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(25, 0.001),(50, 0.0001),(75, 0.00001),(100, 0.0001)]}
