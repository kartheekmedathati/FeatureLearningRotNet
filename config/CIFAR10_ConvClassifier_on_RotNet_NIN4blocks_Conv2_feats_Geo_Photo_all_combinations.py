...
networks = {}
feat_net_opt = {'num_classes': 16, 'num_stages': 4, 'use_avg_on_conv3': False}
feat_pretrained_file = './experiments/CIFAR10_RotNet_NIN4blocks_Geo_Photo_all_combinations/model_net_epoch75'
...
cls_net_optim_params = {'optim_type': 'sgd', 'lr': 0.1, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(10, 0.01),(30, 0.01),(40, 0.001),(100, 0.0001)]}
