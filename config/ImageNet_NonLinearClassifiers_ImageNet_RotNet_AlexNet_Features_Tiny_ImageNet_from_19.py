...
pretrained = './experiments/ImageNet_RotNet_AlexNet_Tiny_Imagenet_from_19/model_net_epoch8'

networks['feat_extractor'] = {'def_file': 'architectures/AlexNet.py', 'pretrained': pretrained, 'opt': {'num_classes': 16},  'optim_params': None} 
...
net_optim_params_cls = {'optim_type': 'sgd', 'lr': 0.1, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(10, 0.01),(20, 0.0002),(30, 0.0004),(40, 0.00008)]}
